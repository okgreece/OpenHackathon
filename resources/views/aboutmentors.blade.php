    ...
    <main class="container mx-auto px-6 py-8 flex flex-col items-center w-full max-w-screen-xl">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div
                ...
                <img src="{{ asset('/img/mentors-img/thanopoulos.jpg') }}" alt="Mentor Photo"
                    class="w-28 h-28 rounded-full object-cover shadow-md mb-5">

                <h3 class="text-xl font-semibold text-gray-800 mb-1">Αθανάσιος Κων. Θανόπουλος</h3>
                <span class="text-sm text-gray-500 mb-4">Πρόεδρος ΕΛΣΤΑΤ</span>

                <p class="text-sm text-gray-600 text-justify overflow-y-auto pr-2 max-h-60 w-full">
                    Ο Αθανάσιος Κων. Θανόπουλος είναι Πρόεδρος της Ελληνικής Στατιστικής Αρχής (ΕΛΣΤΑΤ)
                    από το 2016 και μέλος της Ευρωπαϊκής Συμβουλευτικής Επιτροπής για τις Στατιστικές
                    (European Statistical Advisory Committee- ESAC) ορισθείς από την Επιτροπή του
                    Ευρωπαϊκού Στατιστικού Συστήματος (European Statistical System Committee – ESSC).
                    Σπούδασε Οικονομικά στο Εθνικό και Καποδιστριακό Πανεπιστήμιο Αθηνών, στην
                    Οικονομική Σχολή της Τουλούζης και στο Πανεπιστήμιο του Πίτσμπουργκ.
                    Πριν την επιλογή του, από διεθνή επιτροπή εμπειρογνωμόνων, στη θέση του Προέδρου της
                    ΕΛΣΤΑΤ, δίδαξε για περισσότερα από 15 έτη σε Πανεπιστήμια στις ΗΠΑ, στη Γαλλία και
                    στην Ελλάδα στους τομείς των οικονομικών, της οικονομετρίας και της στατιστικής.
                    Διετέλεσε, επίσης, σύμβουλος σε θέματα εξυγίανσης τραπεζών, κοινωνικής ασφάλισης και
                    ανάλυσης της βιωσιμότητας του δημόσιου χρέους στο Συμβούλιο Οικονομικών
                    Εμπειρογνωμόνων (ΣΟΕ), ενώ συμμετείχε ως εμπειρογνώμονας στις διαπραγματεύσεις για
                    τα τρία προγράμματα οικονομικής προσαρμογής της Ελλάδας σε κρίσιμους τομείς
                    πολιτικής, όπως η στατιστική διακυβέρνηση, η κοινωνική ασφάλιση, οι φαρμακευτικές
                    δαπάνες και η βιωσιμότητα του δημόσιου χρέους.
                    Το ερευνητικό του έργο καλύπτει ευρύ φάσμα αντικειμένων, όπως Δυναμικά Στοχαστικά
                    Μοντέλα Γενικής Ισορροπίας (DSGE), δυναμική του δημόσιου χρέους, μεταρρύθμιση της
                    κοινωνικής ασφάλισης, στατιστική διακυβέρνηση, ανάλυση δεδομένων, στατιστική παιδεία,
                    και έχει δημοσιευτεί σε έγκυρα διεθνή επιστημονικά περιοδικά στο πεδίο των οικονομικών
                    της ανάλυσης στατιστικών δεδομένων και της πληροφορικής, μεταξύ των οποίων Journal of
                    Public Economics, Journal of Economic Dynamics and Control, Applied Computing and
                    Informatics, Remote Sensing, Statistical Journal of the IAOS.
                </p>
            </div>
            ...
            <div
                ...
                <img src="{{ asset('/img/mentors-img/karamixalakou.jpg') }}" alt="Mentor Photo"
                    class="w-28 h-28 rounded-full object-cover shadow-md mb-5">

                <h3 class="text-xl font-semibold text-gray-800 mb-1">Χριστίνα Καραμιχαλάκου</h3>
                <span class="text-sm text-gray-500 mb-4">Προϊστάμενη της Διεύθυνσης Στατιστικών Επιχειρήσεων</span>

                <p class="text-sm text-gray-600 text-justify overflow-y-auto pr-2 max-h-60 w-full">
                    Η Χριστίνα Καραμιχαλάκου είναι από το 2019 Διευθύντρια Στατιστικών Επιχειρήσεων
                    στην Ελληνική Στατιστική Αρχή (ΕΛΣΤΑΤ), στην οποία εργάζεται συνολικά από το
                    2004. Ξεκίνησε την επαγγελματική της σταδιοδρομία στον τραπεζικό κλάδο, όπου
                    εργάστηκε την περίοδο 1999-2004. Είναι κάτοχος μεταπτυχιακού διπλώματος
                    ειδίκευσης στη Στατιστική από το Οικονομικό Πανεπιστήμιο Αθηνών, πτυχιούχος του
                    Τμήματος Διεθνών και Ευρωπαϊκών Οικονομικών Σπουδών του Οικονομικού
                    Πανεπιστήμιου Αθηνών και πτυχιούχος του Τμήματος Στατιστικής του Οικονομικού
                    Πανεπιστήμιου Αθηνών. Έχει εξειδίκευση και πολυετή εμπειρία στην παραγωγή
                    επίσημων και πειραματικών στατιστικών σε διαφορετικά αντικείμενα, όπως
                    στατιστικές επιχειρήσεων, εθνικοί λογαριασμοί, απογραφή πληθυσμού, καθώς και σε
                    θεσμικά-στρατηγικά θέματα που διέπουν τη λειτουργία των Εθνικών Στατιστικών
                    Υπηρεσιών των κρατών μελών της Ευρωπαϊκής Ένωσης. Διδάσκει, από το 2020,
                    στο Μεταπτυχιακό Πρόγραμμα Σπουδών στη «Στατιστική και Μοντελοποίηση» του
                    Τμήματος Μαθηματικών του Αριστοτέλειου Πανεπιστημίου Θεσσαλονίκης που φέρει
                    την πιστοποίηση European Master in Official Statistics (EMOS) για το μάθημα
                    «Επίσημες Στατιστικές» και έχει εργαστεί ως συνεπιβλέπουσα σε διατριβές φοιτητών
                    του προγράμματος, στις οποίες η ΕΛΣΤΑΤ έχει παράσχει το θέμα και τα δεδομένα για
                    την έρευνα.
                </p>
            </div>
            ...
            <div
                ...
                <img src="{{ asset('/img/mentors-img/papadreou.jpg') }}" alt="Mentor Photo"
                    class="w-28 h-28 rounded-full object-cover shadow-md mb-5">

                <h3 class="text-xl font-semibold text-gray-800 mb-1">Κωνσταντίνος Παπανδρέου</h3>
                <span class="text-sm text-gray-500 mb-4">Προϊστάμενος του Τμήματος Στατιστικών Ενέργειας και
                    Περιβάλλοντος</span>

                <p class="text-sm text-gray-600 text-justify overflow-y-auto pr-2 max-h-60 w-full">
                    Ο Κωνσταντίνος Παπανδρέου είναι από το 2019 προϊστάμενος Τμήματος
                    Στατιστικών Ενέργειας και Περιβάλλοντος στην Ελληνική Στατιστική Αρχή (ΕΛΣΤΑΤ),
                    στην οποία εργάζεται συνολικά από το 2004. Έχει εμπειρία στην κατάρτιση
                    λογαριασμών περιβάλλοντος (Αερίων ρύπων, Φυσικής ροής ενέργειας, Ροής υλικών
                    και Οικονομικών λογαριασμών περιβάλλοντος), στατιστικές αποβλήτων και υδάτων
                    κ.α. Έχει εμπειρία στην παραγωγή και άλλων τομέων επίσημων στατιστικών, όπως
                    είναι οι εθνικοί λογαριασμοί και οι στατιστικές εμπορικής ναυτιλίας καθώς και στην
                    εκπροσώπηση της ΕΛΣΤΑΤ σε διεθνείς και ευρωπαϊκές επιτροπές ή ομάδες εργασίας
                    για θέματα επίσημων στατιστικών. Είναι πτυχιούχος του Τμήματος Στατιστικής του
                    Οικονομικού Πανεπιστήμιου Αθηνών (1998) και κάτοχος των μεταπτυχιακών
                    διπλωμάτων MSc στις Επιστήμες Αποφάσεων (2001) και ΜΒΑ σε Τεχνοοικονομικά
                    συστήματα (2002).
                </p>
            </div>
        </div>
